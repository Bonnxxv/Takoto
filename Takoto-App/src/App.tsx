...
function App() {
  ...
  React.useEffect(() => {
    const hasCompletedSetup = localStorage.getItem('takoto-setup-completed')
    ...
    <ThemeProvider defaultTheme="system" storageKey="vite-ui-theme">
      <TooltipProvider>
        <div className="flex flex-col h-screen overflow-hidden">
          {/* Top Menu Bar */}
          {isMobile && (
            <header className="sticky top-0 flex shrink-0 items-center justify-between border-b border-border bg-background/80 backdrop-blur-sm p-2 sm:p-2.5 z-20 min-w-0 shadow-apple-sm">
              <ThemeToggle />
