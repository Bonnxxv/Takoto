...
interface GlobalContextType {
  ...
  clearTranscriptionData: () => void; // <-- TAMBAHAN: Definisi fungsi baru
}
...
export function GlobalProvider({ children }: GlobalProviderProps) {
  ...
  async function initializeStore() {
    try {
      const loadedStore = await load('takoto-store.json', { autoSave: false });
  ...
  return (
    <GlobalContext.Provider value={{
      ...
      clearTranscriptionData, // <-- TAMBAHAN: Export fungsi agar bisa digunakan komponen lain
    }}>
      {children}
