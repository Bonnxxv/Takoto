    ...
    return (
        <Alert className="pt-3 relative bg-blue-50/90 border border-blue-200 dark:bg-blue-950/90 dark:border-blue-700 animate-in fade-in-0 zoom-in-95 overflow-hidden">
            ...
            <Button
                variant="ghost"
                size="icon"
                aria-label="Tutup notifikasi survei"
                onClick={onDismiss}
            ...
            <div className="flex flex-col gap-3 p-1 pr-2">
                ...
                <div className="flex items-center gap-2">
                    <img src="/takoto-logo.png" className="h-7 w-7" />
                    <strong className="text-base font-bold text-blue-900 dark:text-blue-100">
                        Peringatan Proyek Rahasia!
                    </strong>
                </div>
                {/* Body text and survey link */}
                <p className="text-sm text-blue-800 dark:text-blue-200 leading-relaxed ">
                    Halo, Tom di sini, dev solo di balik Takoto! 🚀<br /><br />
                    Saya sedang membangun sesuatu yang baru dan ingin mendengar <span className="font-semibold text-blue-700 dark:text-blue-300">ide fitur gila</span> Anda. <span className="italic">Apa yang akan membuat pikiran Anda meledak?</span>
                </p>
                ...
                >
                    <a
                        ...
                        aria-label="Bagikan ide Anda dalam survei 1 menit saya"
                    >
                        Bagikan ide Anda dalam survei 1 menit saya
                    </a>
                </Button>
            </div>
        </Alert>
