    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[calc(100vh-2rem)]">
                <DialogHeader>
                    <DialogTitle>Edit Pembicara</DialogTitle>
                    <DialogDescription className="text-sm">Ini adalah pembicara yang terdeteksi dalam audio.</DialogDescription>
                </DialogHeader>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Tooltip>
                                                ...
                                                <TooltipContent side="bottom" align="center" className="text-xs">
                                                    Lompat ke sampel di garis waktu
                                                </TooltipContent>
                                            </Tooltip>
                                    ...
                                    <CardContent className="p-4 pb-2 border-t space-y-3 mb-2">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div className="space-y-2">
                                                <Label htmlFor={`name-${index}`}>Nama</Label>
                                                <Input
                                                    id={`name-${index}`}
                                                    value={speaker.name}
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                >
                                                    <SelectTrigger className="w-full">
                                                        <SelectValue placeholder="Pilih trek" />
                                                    </SelectTrigger>
                                                    <SelectContent>
