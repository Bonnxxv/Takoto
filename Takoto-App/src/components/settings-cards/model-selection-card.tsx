            ...
            <Dialog>
              ...
              <DialogContent className="sm:w-[70vw] w-[90vw] p-4 flex flex-col gap-6" onOpenAutoFocus={e => e.preventDefault()}>
                ...
                <span className="text-sm text-muted-foreground">
                  Ini akan menghapus <span className="font-bold">{models[selectedModel].label}</span> model dari perangkat Anda. <br /><br /> Jika Anda menggunakan model ini di masa depan, itu perlu diunduh lagi.
                </span>
